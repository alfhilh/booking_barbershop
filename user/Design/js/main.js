...
$('.delete_service_bttn').click(function()
{
    ...
    $.ajax(
    {
        ...
        error: function(xhr, status, error) 
        {
            alert('ANN ERROR HAS BEEN ENCOUNTERED WHILE TRYING TO EXECUTE YOUR REQUEST');
        }
      });
});
...
*/
 ...
 $('.delete_profile_bttn').click(function()
{
    ...
    $.ajax(
    {
        ...
        success: function (data) 
        {
            swal("Delete Employee","The employee has been deleted successfully!", "success").then((value) => {
                window.location.replace("pelanggan.php");
            });     
        },
        error: function(xhr, status, error) 
        {
            alert('asdada AN ERROR HAS BEEN ENCOUNTERED WHILE TRYING TO EXECUTE YOUR REQUEST');
        }
    });
});